//! TCVN3 (TCVN 5712) encoding support

use std::collections::HashMap;

/// TCVN3 encoding utilities
pub struct Tcvn3Encoding {
...
impl Tcvn3Encoding {
    ...
    pub fn new() -> Self {
        ...
        let mappings = [
            ...
            (0x1EC9, 0xEE), // ỉ
            (0x0129, 0xEF), // ĩ
            (0x1ECB, 0xF0), // ị (Note: This might conflict with NULL)
...
impl Default for Tcvn3Encoding {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    fn test_tcvn3_conversion() {
        let encoding = Tcvn3Encoding::new();
